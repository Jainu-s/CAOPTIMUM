...
#     """Recursively delete content of a folder."""
...
#     """Extract text from the given HTML file."""
...
#
#         # Diagnostic print
#         print(f"Checking sub-folder: {sub_folder_name}...")
#         if os.path.isdir(fail_sub_folder_path):
#             print(f"Found in 'Test Case Failed': {sub_folder_name}")
#         if os.path.isdir(pass_sub_folder_path):
#             print(f"Found in 'Test Case Passed': {sub_folder_name}")
#
...
#             delete_folder_content(pass_sub_folder_path)
...
#                             html_path = os.path.join(sub_folder_path, filename)
#                             text = extract_text_from_html(html_path).lower()
...
#
#                     filtered_expected_text = remove_stopwords(expected_text)
#                     concatenated_text = remove_stopwords(concatenated_text)  # Also remove stopwords from concatenated text
#
